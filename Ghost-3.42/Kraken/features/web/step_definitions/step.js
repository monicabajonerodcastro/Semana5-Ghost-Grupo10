...
When('I click on new post', async function(){
    let section = await this.driver.$('a[href="#/posts/"]');
...
When ('I confirm the publishing post', async function(){
    let elements = await this.driver.$$('.gh-publishmenu-radio-label');
...
Then('I see the post confirmation', async function(){
    let element = await this.driver.$$('.gh-notification-passive');
...
Then('I see the preview of the facebook card with the title {string} and the description {string}', async function(title, description){
    let elementTitleList = await this.driver.$$('.gh-og-preview-title');
    ...
    let elementDescriptionList = await this.driver.$$('.gh-og-preview-description');
...
Then('I expect to see the facebook card preview with title {string}', async function(title){
    ...
    let elementTitle = await this.driver.$('.gh-og-preview-title');
