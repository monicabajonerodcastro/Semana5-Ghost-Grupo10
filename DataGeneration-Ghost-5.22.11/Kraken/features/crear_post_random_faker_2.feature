...
@user4 @web
Scenario: Scenario19: As an admin user, I want to create a post with custom URL
...
@user5 @web
Scenario: Scenario20: As an admin user, I want to create a post with bad URL
    Given I navigate page "<LOGIN_URL>"
    And I wait for 3 seconds
    When I enter email "<USERNAME>"
    And I wait for 1 seconds
...
@user6 @web
Scenario: Scenario21: As an admin user, I want to create a post with a future date
    Given I navigate page "<LOGIN_URL>"
    And I wait for 3 seconds
    When I enter email "<USERNAME>"
    And I wait for 1 seconds
